//-------------------------------------------------------------------------
// MeshMultiCgraRTL__32b0f43a53fc83e4.v
//-------------------------------------------------------------------------
...
(
  ...
  always_comb begin : _lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_out
...
(
  ...
  localparam logic [0:0] __const__i_at__lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__0_  = 1'd0;
  localparam logic [0:0] __const__i_at__lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__1_  = 1'd1;
  localparam logic [1:0] __const__i_at__lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__2_  = 2'd2;
  localparam logic [1:0] __const__i_at__lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__3_  = 2'd3;
  ...
  always_comb begin : _lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__0_
    reduce_add__in_[2'd0] = ( recv_opt__msg.operation == 6'( __const__OPT_VEC_MUL ) ) ? temp_result[2'( __const__i_at__lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__0_ )] : 32'd0;
  end
  ...
  always_comb begin : _lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__1_
    reduce_add__in_[2'd1] = ( recv_opt__msg.operation == 6'( __const__OPT_VEC_MUL ) ) ? temp_result[2'( __const__i_at__lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__1_ )] : 32'd0;
  end
  ...
  always_comb begin : _lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__2_
    reduce_add__in_[2'd2] = ( recv_opt__msg.operation == 6'( __const__OPT_VEC_MUL ) ) ? temp_result[2'( __const__i_at__lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__2_ )] : 32'd0;
  end
  ...
  always_comb begin : _lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__3_
    reduce_add__in_[2'd3] = ( recv_opt__msg.operation == 6'( __const__OPT_VEC_MUL ) ) ? temp_result[2'( __const__i_at__lambda__s_dut_cgra_0__tile_0__element_fu_9__reduce_add_in__3_ )] : 32'd0;
  end
...
module FlexibleFuRTL__5e870a5d31bfb5b9
(
  input  logic [0:0] clk ,
  ...
  input logic [0:0] send_out__rdy [0:1] ,
  output logic [0:0] send_out__val [0:1] ,
  output logic [8:0] to_mem_raddr__msg [0:11] ,
  input logic [0:0] to_mem_raddr__rdy [0:11] ,
  output logic [0:0] to_mem_raddr__val [0:11] ,
  output logic [8:0] to_mem_waddr__msg [0:11] ,
  ...
  logic [8:0] fu__to_mem_raddr__msg [0:11];
  logic [0:0] fu__to_mem_raddr__rdy [0:11];
  logic [0:0] fu__to_mem_raddr__val [0:11];
  logic [8:0] fu__to_mem_waddr__msg [0:11];
  ...
  VectorMulComboRTL__a499f8f134d9aa6b fu__9
  (
    .clk( fu__clk[9] ),
    .reset( fu__reset[9] ),
  ...
  VectorAdderComboRTL__a499f8f134d9aa6b fu__10
  (
    .clk( fu__clk[10] ),
    .reset( fu__reset[10] ),
  ...
  NahRTL__b48d5d572c75e2e4 fu__11
  (
    .clk( fu__clk[11] ),
    .reset( fu__reset[11] ),
...
module TileRTL__14fbee7e8f429815
(
  input  logic [3:0] cgra_id ,
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  ...
  logic [8:0] element__to_mem_raddr__msg [0:11];
  logic [0:0] element__to_mem_raddr__rdy [0:11];
  logic [0:0] element__to_mem_raddr__val [0:11];
  logic [8:0] element__to_mem_waddr__msg [0:11];
  ...
  FlexibleFuRTL__5e870a5d31bfb5b9 element
  (
    .clk( element__clk ),
...
(
  ...
  TileRTL__14fbee7e8f429815 tile__0
  (
  ...
  TileRTL__14fbee7e8f429815 tile__1
  (
  ...
  TileRTL__14fbee7e8f429815 tile__2
  (
  ...
  TileRTL__14fbee7e8f429815 tile__3
  (
...
(
  ...
  CgraRTL__0776e820a031c1e9 cgra__0
  (
  ...
  CgraRTL__0776e820a031c1e9 cgra__1
  (
  ...
  CgraRTL__0776e820a031c1e9 cgra__2
  (
  ...
  CgraRTL__0776e820a031c1e9 cgra__3
  (
  ...
  CgraRTL__0776e820a031c1e9 cgra__4
  (
  ...
  CgraRTL__0776e820a031c1e9 cgra__5
  (
  ...
  CgraRTL__0776e820a031c1e9 cgra__6
  (
  ...
  CgraRTL__0776e820a031c1e9 cgra__7
  (
  ...
  CgraRTL__0776e820a031c1e9 cgra__8
  (
